...
var houndRequest = {
    ...
    "SpokenResponse" : "Ok, I'm Moveing Up",
    "SpokenResponseLong" : "Ok, I'm Moveing",
    "WrittenResponse" : "Ok, I'm Moveing Up",
    "WrittenResponseLong" : "Ok, I'm Moveing Up"},
      "Expression" : " (\"Move\")  . (\"Right\") ",
      "Result" : { "Intent" : "MOVE_RIGHT" },
    "SpokenResponse" : "Ok, I'm Moveing Right",
    "SpokenResponseLong" : "Ok, I'm Moveing Right",
    "WrittenResponse" : "Ok, I'm Moveing Right",
    "WrittenResponseLong" : "Ok, I'm Moveing Right"}, 
      "Expression" : " (\"Move\")  . (\"Left\") ",
      "Result" : { "Intent" : "MOVE_LEFT" },
    "SpokenResponse" : "Ok, I'm Moveing Left",
    "SpokenResponseLong" : "Ok, I'm Moveing Left",
    "WrittenResponse" : "Ok, I'm Moveing Left",
    "WrittenResponseLong" : "Ok, I'm Moveing Left"},
      "Expression" : " (\"Move\")  . (\"Down\") ",
      "Result" : { "Intent" : "MOVE_DOWN" },
    "SpokenResponse" : "Ok, I'm Moveing Down",
    "SpokenResponseLong" : "Ok, I'm Moveing Down",
    "WrittenResponse" : "Ok, I'm Moveing Down",
    "WrittenResponseLong" : "Ok, I'm Moveing"},
